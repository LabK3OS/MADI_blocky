...
Blockly.Python['neopin'] = function(block) {
  ...
  var code = variable_variable + ' = NeoPixel(Pin(' + dropdown_pin + ', Pin.OUT),' + number_cantidad + ')\n';
  return code;
};
...
Blockly.Python['neo_cual'] = function(block) {
  ...
  // TODO: Assemble Python into code variable.
  var code = value_variable + '[' + value_numero + '-1] = hex_to_rgb(' + value_rgb + ')\n';
  return code;
};
